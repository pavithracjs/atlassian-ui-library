...
export const messages = defineMessages({
  ...
  show_more_button_text: {
    ...
    description: 'Text for button that is used to load more results for a search'
  },
  show_more_error: {
  ...
  show_more_button_advanced_search: {
    ...
    description: 'Text for button that is used when we cannot load more results and direct user to advanced search'
  },
});
