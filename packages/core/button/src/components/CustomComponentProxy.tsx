 ...
 * acts as a layer which catches the appearance-related properties so that they can be used to style
 * the button, then passes the rest of the props on to the custom component.
 */
