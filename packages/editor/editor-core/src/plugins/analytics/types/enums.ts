...
export const INPUT_METHOD: IInputMethod = {
  ASCII: 'ascii',
  AUTO: 'auto',
  AUTO_DETECT: 'autoDetect',
  CARD: 'card',
...
export const ACTION_SUBJECT: IActionSubject = {
  BUTTON: 'button',
  DOCUMENT: 'document',
  EDITOR: 'editor',
  MEDIA: 'media',
...
export interface IActionSubjectId {
  ACTION: 'action';
...
export const ACTION_SUBJECT_ID: IActionSubjectId = {
  ACTION: 'action',
  ANNOTATE_BUTTON: 'annotateButton',
  BLOCK_QUOTE: 'blockQuote',
  BUTTON_HELP: 'helpButton',
