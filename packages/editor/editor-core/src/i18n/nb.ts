...
// Norwegian Bokmål
export default {
  'fabric.editor.layoutFixedWidth': 'Tilbake til standard bredde',
  'fabric.editor.layoutWide': 'Velg bredt',
  'fabric.editor.layoutFullWidth': 'Velg full bredde',
  ...
  'fabric.editor.blockquote.description': 'Sett inn sitat eller henvisning',
  ...
  'fabric.editor.action.description':
    'Registrer handlinger for å få arbeidet til å gå videre',
  'fabric.editor.link': 'Kobling',
  'fabric.editor.link.description': 'Kobling til en intern eller ekstern side',
  ...
  'fabric.editor.status.description': 'Lag en farget rombe med tekst inni',
