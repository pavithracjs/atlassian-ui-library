...
export default {
  ...
  'fabric.editor.layoutFullWidth': 'Ampliar total',
  ...
  'fabric.editor.action.description': 'Capturar ações para avançar o trabalho',
  'fabric.editor.link': 'Link',
  'fabric.editor.link.description': 'Link para uma página interna ou externa',
  ...
  'fabric.editor.status.description': 'Criar um lozango com texto dentro',
