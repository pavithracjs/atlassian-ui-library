...
export default {
  ...
  'fabric.editor.action.description':
    'Capturați acțiunile pentru a avansa activitatea',
  'fabric.editor.link': 'Link',
  'fabric.editor.link.description': 'Link către o pagină internă sau externă',
  ...
  'fabric.editor.status.description':
    'Creați un romb colorat cu text în interior',
