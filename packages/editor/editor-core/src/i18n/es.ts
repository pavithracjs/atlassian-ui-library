...
export default {
  ...
  'fabric.editor.action.description':
    'Captar acciones para adelantar el trabajo',
  'fabric.editor.link': 'Vincular',
  'fabric.editor.link.description': 'Enlace a una página interna o externa',
  ...
  'fabric.editor.status.description': 'Crear un rombo de color con texto',
