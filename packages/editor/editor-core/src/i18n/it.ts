...
export default {
  ...
  'fabric.editor.action.description':
    'Cattura azioni per far avanzare il lavoro',
  'fabric.editor.link': 'Collega',
  'fabric.editor.link.description': 'Link a una pagina interna o esterna',
  ...
  'fabric.editor.status.description':
    'Crea una losanga colorata con del testo all’interno',
