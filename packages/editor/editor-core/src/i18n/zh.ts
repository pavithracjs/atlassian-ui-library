...
export default {
  ...
  'fabric.editor.layoutWide': '切换宽屏模式',
  ...
  'fabric.editor.action.description': '捕获操作以推动工作进展',
  'fabric.editor.link': '链接',
  'fabric.editor.link.description': '内部或外部页面链接',
  ...
  'fabric.editor.status.description': '使用内部文本创建彩色菱形',
