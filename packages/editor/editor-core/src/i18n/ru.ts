...
export default {
  ...
  'fabric.editor.blockquote.description': 'Вставка цитирования',
  ...
  'fabric.editor.action.description':
    'Записывайте действия, чтобы работа продвигалась быстрее',
  'fabric.editor.link': 'Ссылка',
  'fabric.editor.link.description': 'Ссылка на внутреннюю или внешнюю страницу',
  ...
  'fabric.editor.status.description': 'Цветной ярлык с текстом',
