...
export default {
  ...
  'fabric.editor.action.description':
    'Zaznamenajte činnosti a napredujte v práci',
  'fabric.editor.link': 'Prepojenie',
  'fabric.editor.link.description':
    'Prepojenie na internú alebo externú stránku',
  ...
  'fabric.editor.status.description': 'Vytvorte farebný kosoštvorec s textom',
