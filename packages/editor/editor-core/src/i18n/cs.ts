...
export default {
  ...
  'fabric.editor.action.description':
    'Zaznamenávejte akce, abyste se v práci pohnuli dál',
  'fabric.editor.link': 'Odkaz',
  'fabric.editor.link.description': 'Odkaz na interní nebo externí stránku',
  ...
  'fabric.editor.status.description':
    'Vytvořit barevný kosočtverec s textem uvnitř',
