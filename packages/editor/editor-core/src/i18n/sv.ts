...
// Swedish
export default {
  'fabric.editor.layoutFixedWidth': 'Tillbaka centrera',
  ...
  'fabric.editor.action.description':
    'Fånga åtgärder för att flytta arbete framåt',
  'fabric.editor.link': 'Länk',
  'fabric.editor.link.description': 'Länk till en intern eller extern sida',
  ...
  'fabric.editor.status.description': 'Skapa en färgad romb med text inuti',
