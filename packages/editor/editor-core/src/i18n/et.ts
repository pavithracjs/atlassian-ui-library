...
export default {
  ...
  'fabric.editor.action.description':
    'Saa toimingutest ülevaade, et töö edeneks kiiremini',
  'fabric.editor.link': 'Viide',
  'fabric.editor.link.description':
    'Link ettevõtte sisesele või välimisele lehele',
  ...
  'fabric.editor.status.description': 'Loo teksti sisaldav värviline romb',
