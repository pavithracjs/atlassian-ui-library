...
export const paragraph: NodeSpec = {
  ...
  group: 'block',
  marks:
    'strong code em link strike subsup textColor typeAheadQuery underline mentionQuery emojiQuery confluenceInlineComment action annotationQuery annotation',
  parseDOM: [{ tag: 'p' }],
  toDOM() {
    return pDOM;
  },
