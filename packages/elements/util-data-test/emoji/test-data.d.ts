...
export declare const filterToSearchable: (emojis: any[]) => any[];
...
export declare const searchableEmojis: any[];
...
export declare const getNonUploadingEmojiResourcePromise: (
  config?: MockEmojiResourceConfig | undefined,
) => Promise<any>;
export declare const getEmojiResourcePromise: (
  config?: MockEmojiResourceConfig | undefined,
) => Promise<any>;
export declare const getEmojiResourcePromiseFromRepository: (
  repo: any,
  config?: MockEmojiResourceConfig | undefined,
) => Promise<any>;
