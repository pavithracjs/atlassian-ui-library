...
export declare const getStandardEmojiData: () => any;
export declare const getAtlassianEmojiData: () => any;
export declare const loggedUser = 'blackpanther';
export declare const getSiteEmojiData: () => any;
export declare const getAllEmojiData: () => any;
...
export declare const getEmojiResource: (
  config?: MockEmojiResourceConfig | undefined,
) => Promise<any>;
export declare const getEmojiResourceWithStandardAndAtlassianEmojis: (
  config?: MockEmojiResourceConfig | undefined,
) => Promise<any>;
