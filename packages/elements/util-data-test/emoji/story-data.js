...
var getEmojiSet = function(name) {
  if (!emojisSets) {
    ...
    var standardEmojis = denormaliseEmojiServiceResponse(getStandardEmojiData())
      .emojis;
    var atlassianEmojis = denormaliseEmojiServiceResponse(
...
export var getStandardEmojis = function() {
  return getEmojiSet('standard');
};
export var getAtlassianEmojis = function() {
  return getEmojiSet('atlassian');
};
export var getSiteEmojis = function() {
  return getEmojiSet('site');
};
export var getEmojis = function() {
  return getEmojiSet('all');
};
export var lorem =
...
export var getEmojiRepository = function() {
  return new EmojiRepository(getEmojis());
};
...
export var getEmojiResourceWithStandardAndAtlassianEmojis = function(config) {
  ...
  return mockEmojiResourceFactory(
    new EmojiRepository(tslib_1.__spread(standardEmojis, atlassianEmojis)),
    config,
  );
};
