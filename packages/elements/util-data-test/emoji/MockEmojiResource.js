...
var MockNonUploadingEmojiResource = /** @class */ (function(_super) {
  ...
  MockNonUploadingEmojiResource.prototype.findByShortName = function(
    shortName,
  ) {
  ...
  MockNonUploadingEmojiResource.prototype.findInCategory = function(
    categoryId,
  ) {
  ...
  MockNonUploadingEmojiResource.prototype.getFrequentlyUsed = function(
    options,
  ) {
    return this.promiseBuilder(
  ...
  MockNonUploadingEmojiResource.prototype.optimisticMediaRendering = function(
    emoji,
  ) {
...
export var mockNonUploadingEmojiResourceFactory = function(
  emojiRepository,
  config,
  promiseBuilder,
) {
  var mockEmojiResource = new MockNonUploadingEmojiResource(
    emojiRepository,
    config,
  );
  if (promiseBuilder) {
...
export var mockEmojiResourceFactory = function(
  emojiRepository,
  config,
  promiseBuilder,
) {
