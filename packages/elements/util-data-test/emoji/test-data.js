...
export var mediaEmojiAlternateImagePath =
  mediaBaseUrl + 'alt-path-to-image.png';
...
export var mediaEmoji = tslib_1.__assign({}, mediaEmojiId, {
  name: 'Media example',
  type: customType,
  category: customCategory,
  order: -2,
...
// () => MediaApiToken
export var defaultMediaApiToken = function() {
  return {
    url: mediaBaseUrl,
    clientId: '1234',
    jwt: 'abcd',
...
export var siteServiceEmojis = function() {
  return {
...
// EmojiDescription[]
export var standardEmojis = denormaliseEmojiServiceResponse(
  standardServiceEmojis,
).emojis;
export var atlassianEmojis = denormaliseEmojiServiceResponse(
  atlassianServiceEmojis,
).emojis;
export var siteEmojis = [mediaEmoji];
export var emojis = tslib_1.__spread(
  standardEmojis,
  atlassianEmojis,
  siteEmojis,
);
...
export var openMouthEmoji = defaultEmojiRepository.findByShortName(
  ':open_mouth:',
);
export var grinEmoji = defaultEmojiRepository.findByShortName(':grin:');
export var evilburnsEmoji = defaultEmojiRepository.findByShortName(
  ':evilburns:',
);
export var thumbsupEmoji = defaultEmojiRepository.findByShortName(':thumbsup:');
export var thumbsdownEmoji = defaultEmojiRepository.findByShortName(
  ':thumbsdown:',
);
export var standardBoomEmoji = defaultEmojiRepository.findById('1f4a5');
export var atlassianBoomEmoji = defaultEmojiRepository.findById(
  'atlassian-boom',
);
export var blackFlagEmoji = defaultEmojiRepository.findByShortName(
  ':flag_black:',
);
export var congoFlagEmoji = defaultEmojiRepository.findByShortName(':flag_cg:');
export var getNonUploadingEmojiResourcePromise = function(config) {
  return mockNonUploadingEmojiResourceFactory(newEmojiRepository(), config);
};
export var getEmojiResourcePromise = function(config) {
  return mockEmojiResourceFactory(newEmojiRepository(), config);
};
export var getEmojiResourcePromiseFromRepository = function(repo, config) {
  return mockEmojiResourceFactory(repo, config);
};
