...
export var slowResourceProvider = new MentionResource({
  minWait: 10,
  maxWait: 100,
});
export var resourceProvider = new MentionResource({
  minWait: 10,
  maxWait: 25,
});
export var resourceProviderWithResolver = new MentionResource({
  minWait: 10,
  maxWait: 25,
  mentionNameResolver: createMockMentionNameResolver(),
});
export var resourceProviderWithResolver2 = new MentionResource({
  minWait: 10,
  maxWait: 25,
  mentionNameResolver: createMockMentionNameResolver(),
});
export var resourceProviderWithInfoHints = new MentionResourceWithInfoHints({
  minWait: 10,
  maxWait: 25,
});
